...
get the app created:
    ...
    $ heroku apps:create marume
    Creating marume... done, stack is cedar
    http://marume.herokuapp.com/ | git@heroku.com:marume.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://marume.herokuapp.com deployed to Heroku

    To git@heroku.com:marume.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://marume.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@marume.herokuapp.com/repl
